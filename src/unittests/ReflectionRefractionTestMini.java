...
public class ReflectionRefractionTestMini {
	...
	public void twoSpheresOnMirrors() {
		...
		Render render = new Render() //
				...
				.setCam(camera) //
				.setRayTracerBase(new BasicRayTracer(scene).setDistanceForBlurryGlossy(2)).setDebugPrint().setMultithreading(3);
	...
	public void ourPicture() {
		...
		render.writeToImage();
			...
			//		.setImageWriter(imageWriter) //
			//		.setCam(camera) //
			//		.setRayTracerBase(new BasicRayTracer(scene).setIsimprovement(true).setNumOfRaysGlossy(25).setDistanceForBlurryGlossy(2)).setDebugPrint().setMultithreading(3);

	
		//Render render = new Render() //
		//		.setImageWriter(imageWriter) //
		//		.setCam(camera) //
			//	.setRayTracerBase(new BasicRayTracer(scene).setIsimprovement(true).setNumOfRaysGlossy(25));
	...
	public void Glass() {
		...
		scene.geometries.add(/*new Polygon( // AEFD
				...
				new Sphere(new Point3D(-100, 35, 0), 30).setEmmission(new Color(java.awt.Color.GREEN))
						.setMaterial(new Material().setKd(0.3).setKs(0).set_nShininess(900).setKt(0).setKr(0)
								.setRadiusForGlossy(0.08)),
				new Sphere(new Point3D(100, 35, 0), 30).setEmmission(new Color(java.awt.Color.RED)).setMaterial(
		...
		Render render1 = new Render().setImageWriter(imageWriter1).setCam(camera)
				.setRayTracerBase(new BasicRayTracer(scene)).setMultithreading(3).setDebugPrint().setSupersampling(true);
	...
	public void blurryTest() {
		...
		scene.geometries.add(
				new Polygon(new Point3D(-500, -500, 500), new Point3D(500, -500, 500), new Point3D(500, -700, 250),
						new Point3D(-500, -700, 250)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // SIDE BACK
				new Polygon(new Point3D(-500, 500, 500), new Point3D(500, 500, 500), new Point3D(500, 700, 250),
						new Point3D(-500, 700, 250)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // side front
				new Polygon(new Point3D(500, -500, 500), new Point3D(500, 500, 500), new Point3D(500, 700, 250),
						new Point3D(500, -700, 250)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // side RIGHT
				new Polygon(new Point3D(-500, -500, 500), new Point3D(-500, -700, 250), new Point3D(-500, 700, 250),
						new Point3D(-500, 500, 500)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // side left
				new Polygon(new Point3D(-500, -500, 500), new Point3D(500, -500, 500), new Point3D(500, 500, 500),
						new Point3D(-500, 500, 500)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // up side
				...
				new Polygon(new Point3D(-400, 500, 0), new Point3D(-400, 700, 250), new Point3D(-400, -700, 250),
						new Point3D(-400, -500, 0)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // LEFT SIDE DOWN
				new Polygon(new Point3D(400, -700, 250), new Point3D(400, 700, 250), new Point3D(400, 500, 0),
						new Point3D(400, -500, 0)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // RIGTH SIDE DOWN
				new Polygon(new Point3D(400, 700, 250), new Point3D(-400, 700, 250), new Point3D(-400, 500, 0),
						new Point3D(400, 500, 0)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // front down
				new Polygon(new Point3D(-400, -700, 250), new Point3D(400, -700, 250), new Point3D(400, -500, 0),
						new Point3D(-400, -500, 0)).setEmmission(new Color(java.awt.Color.DARK_GRAY))
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)), // back down
								
								
				new Triangle(new Point3D(490, -350, 150), new Point3D(490, 0, 150), new Point3D(100, 350, 150)) //
								.setMaterial(new Material().setKd(0.5).setKs(0.5).set_nShininess(900)).setEmmission(new Color(java.awt.Color.gray)), //
