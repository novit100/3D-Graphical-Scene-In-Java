...
public class ReflectionRefractionTests {
	...
	public void ourPicture() {
		...
		scene.geometries.add( //
				...
				new Sphere(new Point3D(-100,20,-790),30) //the tiny black sphere
				.setEmmission(new Color(30,0,0)) //
				.setMaterial(new Material().setKd(0).setKs(0).set_nShininess(0).setKt(0).setKr(0)),
				
				new Sphere(new Point3D(-50, 20, -100),20) //the pink sphere
				.setEmmission(new Color(java.awt.Color.pink)) //
				.setMaterial(new Material().setKd(0).setKs(0.20).set_nShininess(100).setKt(0).setKr(0.1)),
				 
				new Triangle(new Point3D(1500, -1500, -1500), new Point3D(-1500, 1500, -1500),//the triangle
				
				new Point3D(0, -1400, -2000)).setEmmission(new Color(java.awt.Color.CYAN)).setMaterial(new Material().setKd(0.25).setKs(0.9).set_nShininess(20).setKt(0).setKr(1))); 
		...
		ImageWriter imageWriter = new ImageWriter("ourPicRefrectionRefraction", 600, 600);
		Render render = new Render() //
				.setImageWriter(imageWriter) //
				.setCam(camera) //
				.setRayTracerBase(new BasicRayTracer(scene));
